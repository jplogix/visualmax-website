...
export function AppointmentBooking() {
  ...
  if (submitted) {
    return (
      <section id="citas" className="py-16 sm:py-24 bg-white">
          ...
          <Card className="card-raise border-primary/30">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-muted-foreground mb-6">
                Hemos recibido tu solicitud de cita. Nuestro equipo se pondrá en contacto contigo dentro de las próximas
                24 horas para confirmar tu cita en {formData.location}.
              </p>
  ...
  return (
    <section id="citas" className="py-16 sm:py-24 section-gradient">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
